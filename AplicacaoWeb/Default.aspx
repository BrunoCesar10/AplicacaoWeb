        ...
        <div class="col-md-4">
            <div class="card" style="max-width: 18rem;">
                <div class="card-body">
                    ...
                    <p class="card-text">Clique no botão abaixo caso seja depois das dez da manhã e antes de meio-dia.</p>
                    <p>
        ...
        <div class="col-md-4">
            <div class="card" style="max-width: 18rem;">
                <div class="card-body">
                    ...
                    <p class="card-text">Clique no botão abaixo caso seja após sete da noite e antes das dez da manhã.</p>
                    <p>
